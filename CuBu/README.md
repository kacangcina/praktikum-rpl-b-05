...
## Konfigurasi Konsultasi AI

Fitur konsultasi memasak memakai Google Gemini API dan system prompt yang dapat
diubah admin melalui menu `Admin > Prompt AI`. Isi konfigurasi berikut
di `.env`, lalu jalankan `php artisan config:clear`:
...
Jalankan pengujian backend dan frontend dengan:
