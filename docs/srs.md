...
Dokumen ini merupakan Software Requirements Specification (SRS) ringkas untuk aplikasi Cookbook App. Dokumen ini mendeskripsikan kebutuhan fungsional dan non-fungsional sistem yang menjadi acuan bagi tim pengembang selama proses pembangunan, pengujian, dan penerimaan produk. SRS ini disusun berdasarkan artefak P2 yang telah divalidasi, meliputi problem statement, user stories, dan product backlog.

### 1.2 Ruang Lingkup

Cookbook App adalah platform belajar memasak berbasis web yang menghubungkan pengguna dengan panduan resep lokal yang terstruktur dan video kelas memasak dari chef terverifikasi. Sistem ini mencakup fitur autentikasi pengguna, publikasi dan pencarian resep, pengelolaan koleksi resep pribadi, penayangan video kelas memasak, konsultasi berbasis AI, serta verifikasi akun creator oleh admin. Sistem tidak mencakup fitur transaksi jual beli, pemesanan katering, atau pembayaran berbayar pada iterasi pertama ini.
...
Cookbook App adalah aplikasi web mandiri yang dibangun untuk menjadi platform belajar memasak digital bagi masyarakat Indonesia. Aplikasi ini beroperasi sebagai ekosistem dua sisi: pengguna yang ingin belajar memasak di satu sisi, dan chef terverifikasi sebagai penyedia konten di sisi lain. Sistem terhubung dengan layanan AI eksternal untuk fitur konsultasi memasak.
