...
FR-01: Sistem menyediakan fitur registrasi akun baru dengan validasi keunikan email. Akun baru langsung berstatus user dan dapat mempublikasikan resep berbasis foto tanpa verifikasi email.  
...
FR-08: Sistem memungkinkan creator terverifikasi untuk menambahkan video MP4 maksimal 500MB pada resep miliknya, dan menampilkan video tersebut langsung pada halaman detail resep kepada pengguna yang sudah login.  
...
FR-10: Sistem menyediakan dashboard verifikasi bagi admin untuk menyetujui atau menolak pengajuan creator, mengirimkan notifikasi hasil verifikasi kepada pemohon, dan memberikan hak upload video hanya kepada creator yang disetujui.  
