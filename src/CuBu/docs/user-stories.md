...
- **AC-02:**  
  ...
  Then sistem membuat akun baru dengan role user, memasukkan pengguna ke dalam aplikasi, dan mengizinkan pengguna membuat resep berbasis foto.
...
**Role:** Creator  
**User Story:**  
As a creator, I want to add a cooking video to my recipe, so that users can learn the recipe steps visually at their own pace.

**Acceptance Criteria:**

- **AC-09:**  
Given creator sudah login sebagai creator terverifikasi dan membuka resep miliknya,  
When creator mengisi judul video, deskripsi, tingkat kesulitan, dan mengunggah file video berformat MP4 lalu menekan "Unggah",  
Then video terpasang pada resep tersebut dan dapat ditonton dari halaman detail resep oleh pengguna yang sudah login.
