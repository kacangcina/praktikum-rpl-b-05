        ...
        <div className="mx-auto max-w-5xl">
            ...
            <form onSubmit={submit} className="mt-7">
                ...
                <div className="border-b border-stone-400 pb-8">
                    ...
                    <label className="relative mx-auto grid size-48 cursor-pointer place-items-center rounded-full bg-stone-200">
                ...
                <div className="divide-y divide-stone-300">
                    <EditRow label="Nama Pengguna"><Field label=""><input className="profile-edit-control" name="username" defaultValue={profile.username} required /></Field></EditRow>
                    <EditRow label="Nama"><Field label=""><input className="profile-edit-control" name="name" defaultValue={profile.name} required /></Field></EditRow>
                    <EditRow label="Bio"><Field label=""><textarea className="profile-edit-control" name="bio" rows="5" defaultValue={profile.bio || ''} /></Field></EditRow>
                </div>
                ...
                <div className="mt-8 flex justify-end gap-4 border-t border-stone-400 pt-8">
                    ...
                    <button className="wire-button wire-button-primary">Simpan</button>
                </div>
            </form>
        </div>
    );
