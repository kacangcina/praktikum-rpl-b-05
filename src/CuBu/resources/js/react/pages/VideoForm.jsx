    ...
    return (
        <div className="mx-auto max-w-3xl">
            ...
            <form onSubmit={async (event) => {
                ...
                <Field label="Judul video"><input name="title" defaultValue={recipe.video?.title || recipe.title} required /></Field>
                <Field label="Deskripsi"><textarea name="description" rows="5" defaultValue={recipe.video?.description || ''} /></Field>
                ...
                <Field label="File MP4"><input type="file" name="video" accept="video/mp4" required={!recipe.video} /></Field>
                <button className="wire-button wire-button-primary">Simpan video</button>
            </form>
        </div>
    );
}
